export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'coxcheer',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Coxcheer',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'coxcheer.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://coxcheer.com',
